...
The frontend is the service in localhelp to serve the web content over Nginx. This will have the web frame for the web application.
...
```
git clone https://github.com/sbp828/localhelp-frontend
...
```
vim /etc/nginx/default.d/localhelp.conf
```
